...
internal sealed class GetEventsForOrganizerQueryHandler(IDbConnectionFactory dbConnectionFactory)
    : IQueryHandler<GetEventsForOrganizerQuery, IReadOnlyCollection<EventResponse>>
{
    public async Task<Result<IReadOnlyCollection<EventResponse>>> Handle(
       GetEventsForOrganizerQuery request,
