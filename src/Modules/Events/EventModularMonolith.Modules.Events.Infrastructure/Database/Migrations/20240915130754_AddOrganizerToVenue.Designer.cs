...
namespace EventModularMonolith.Modules.Events.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240915130754_AddOrganizerToVenue")]
    partial class AddOrganizerToVenue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventModularMonolith.Modules.Events.Domain.Organizers.Organizer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EventModularMonolith.Modules.Events.Domain.Venues.Venue", b =>
                {
                    ...
                    b.HasIndex("OrganizerId")
                        .HasDatabaseName("ix_venues_organizer_id");
            ...
            modelBuilder.Entity("EventModularMonolith.Modules.Events.Domain.Events.Event", b =>
                {
                    ...
                    b.HasOne("EventModularMonolith.Modules.Events.Domain.Organizers.Organizer", null)
                        .WithMany()
                        .HasForeignKey("OrganizerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_events_organizer_organizer_id");
            ...
            modelBuilder.Entity("EventModularMonolith.Modules.Events.Domain.Organizers.Organizer", b =>
                {
                    b.OwnsMany("EventModularMonolith.Modules.Events.Domain.Organizers.Moderator", "Moderators", b1 =>
                        {
                            ...
                            b1.ToTable("moderators", "events");

                            b1.WithOwner()
                                .HasForeignKey("OrganizerId")
                                .HasConstraintName("fk_moderators_organizer_organizer_id");

                            b1.OwnsOne("EventModularMonolith.Modules.Events.Domain.Organizers.ModeratorRole", "Role", b2 =>
                                {
            ...
            modelBuilder.Entity("EventModularMonolith.Modules.Events.Domain.Venues.Venue", b =>
                {
                    b.HasOne("EventModularMonolith.Modules.Events.Domain.Organizers.Organizer", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_venues_organizer_organizer_id");
